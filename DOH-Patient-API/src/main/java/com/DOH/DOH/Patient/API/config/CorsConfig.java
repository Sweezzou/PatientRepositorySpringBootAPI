...
public class CorsConfig {
	...
	public CorsFilter corsFilter() {
		...
		corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000/patient","http://localhost:3000","http://localhost:3001","http://chd6hris.chd6","http://192.168.100.162:3000","http://192.168.100.162:81","http://192.168.100.162:82","http://192.168.100.162:82/hris"));
